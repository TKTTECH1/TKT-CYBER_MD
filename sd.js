...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("TKT-CYBER~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 TKT-CYBER-MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 ** TKT-CYBER-MD BOT Connected Successfully!** ✅ 
          
          --- Welcome to TKT-CYBER_MD---
       ...
       ~ **PREFIX:** ${config.PREFIX}
          ...
          --- Thank you for using TKT-CYBER_MD. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["263718095555@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363418027651738@newsletter",
            newsletterName: "TKT-CYBER_MD",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "TKT-CYBER_MD",
            body: "TKT-CYBER_TECH",
            mediaType: 1,
            sourceUrl: "https://github.com/TKTTECH1/TKT-CYBER_MD",
            thumbnailUrl:
              "https://files.catbox.moe/lfne89.png", // This should match the image URL provided above
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey I am alive, TKT-CYBER_MD Is started✅");
});
app.listen(port, () =>
